...
class aThemes_Hero_Slider extends Widget_Base {
	...
	public function get_title() {
		return __( 'aThemes: Slider', 'sydney' );
	}
	...
	protected function _register_controls() {
		...
		$repeater->start_controls_tab( 'slider_content', [ 'label' => __( 'Content', 'sydney' ) ] );

		//Start content fields
		$repeater->add_control(
			'slide_heading',
			[
				'label' => __( 'Title & Description', 'sydney' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Slide Heading', 'sydney' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'slide_description',
			[
				'label' => __( 'Description', 'sydney' ),
				'type' => Controls_Manager::WYSIWYG,
				'default' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'sydney' ),
				'show_label' => false,
			]
		);
		...
		$repeater->add_control(
			'content_alignment',
			[
				'label' => __( 'Content alignment', 'sydney' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'default'	=> 'left',
				'options' => [
					'left' => [
						'title' => __( 'Left', 'sydney' ),
						'icon' => 'eicon-h-align-left',
					],
					'center' => [
						'title' => __( 'Center', 'sydney' ),
						'icon' => 'eicon-h-align-center',
					],
					'right' => [
						'title' => __( 'Right', 'sydney' ),
		...
		$repeater->add_control(
			'content_animation',
			[
				'label' 	=> __( 'Content Animation', 'sydney' ),
				'type' 		=> Controls_Manager::SELECT,
				'default' 	=> '',
				'options' 	=> [
					'' 				=> __( 'None', 'sydney' ),
					'fadeInDown' 	=> __( 'Fade in down', 'sydney' ),
					'fadeInUp' 		=> __( 'Fade in up', 'sydney' ),
					'fadeInRight' 	=> __( 'Fade in right', 'sydney' ),
					'fadeInLeft' 	=> __( 'Fade in left', 'sydney' ),
					'zoomIn' 		=> __( 'Zoom in', 'sydney' ),
				],
			]
		);		
		...
		$repeater->start_controls_tab( 'slider_style', [ 'label' => __( 'Style', 'sydney' ) ] );
		...
		$repeater->add_control(
			'background_size',
			[
				'label' => __( 'Background size', 'sydney' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'cover',
				'options' => [
		...
		$repeater->add_control(
			'enable_overlay',
			[
				'label' => __( 'Enable overlay', 'sydney' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'slide_heading' => __( 'Welcome to Sydney', 'sydney' ),
						'slide_description' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id nunc rutrum libero posuere rutrum vel a nibh. Etiam vulputate, nulla ac dapibus porta, elit mauris sollicitudin nulla, nec mollis urna sem nec justo.', 'sydney' ),
						'background_color'	=> '#31608B',
						'heading_color'		=> '#fff',
						'text_color'		=> '#fff',
					],
					[
						'slide_heading' => __( 'We hope you enjoy your stay', 'sydney' ),
						'slide_description' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id nunc rutrum libero posuere rutrum vel a nibh. Etiam vulputate, nulla ac dapibus porta, elit mauris sollicitudin nulla, nec mollis urna sem nec justo.', 'sydney' ),
		...
		$this->add_control(
			'autoplay_speed',
			[
				'label' => __( 'Autoplay speed [ms]', 'sydney' ),
		...
		$this->add_control(
			'show_pagination',
			[
				'label' => __( 'Show pagination', 'sydney' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',				
			]
		);
		...
		$this->add_control(
			'show_navigation',
			[
				'label' => __( 'Show navigation', 'sydney' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',				
			]
		);		
		...
		$this->add_control(
			'hover_animation',
			[
				'label' => __( 'Hover Animation', 'sydney' ),
